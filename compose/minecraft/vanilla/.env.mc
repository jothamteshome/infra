...
MODRINTH_PROJECTS=fabric-api,lithium,krypton,ferrite-core,spark,wizards,archers,paladins-and-priests,rogues-and-warriors,jewelry,relics-rpg,arsenal-rpg-series,dynamic-torches,explorify,hearths,nice-mobs-remastered,vanilla-refresh,true-ending,dungeons-and-taverns,netherweather,neoenchant,tool-trims,infinity-cave:beta,playeranimator:beta
